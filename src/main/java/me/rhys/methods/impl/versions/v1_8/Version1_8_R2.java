...
public class Version1_8_R2 extends MethodAbstraction {
    ...
    public Entity getEntityFromID(World world, int entityID) {
        net.minecraft.server.v1_8_R2.Entity entity = ((CraftWorld) world).getHandle().a(entityID);
