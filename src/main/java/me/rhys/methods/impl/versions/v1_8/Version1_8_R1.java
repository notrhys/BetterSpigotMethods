...
public class Version1_8_R1 extends MethodAbstraction {
    ...
    public Entity getEntityFromID(World world, int entityID) {
        net.minecraft.server.v1_8_R1.Entity entity = ((CraftWorld) world).getHandle().a(entityID);
